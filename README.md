...
-   press the key `n` to start/stop recording the narrative - a red circle appears in the upper right corner of the slideshow, indicating that the recorder is running
